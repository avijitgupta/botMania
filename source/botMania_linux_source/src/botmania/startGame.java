...
public class startGame {
   ...
   status stat;
   int ref_k=0;
   int flagx1,flagx2,flagy1,flagy2;
   int apiCount=0;
    ...
    public void initAll()
    {
      ...
      try{
                child = Runtime.getRuntime().exec("./bot1");
		...
		child1 = Runtime.getRuntime().exec("./bot2");
		...
		child2 = Runtime.getRuntime().exec("./bot3");
		...
		child3 = Runtime.getRuntime().exec("./bot4");
		...
		//bx.setPriority(3);
                ...
                child4 = Runtime.getRuntime().exec("./bot5");
		...
		//bx.setPriority(2);
                ...
                child5 = Runtime.getRuntime().exec("./bot6");
